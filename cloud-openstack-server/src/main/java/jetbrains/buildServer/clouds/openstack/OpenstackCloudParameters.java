...
public interface OpenstackCloudParameters {
    @NotNull
    String CLOUD_TYPE = "Openstack";
    @NotNull
    String CLOUD_DISPLAY_NAME = "Openstack Cloud";

    @NotNull
    String INDENTITY_URL = "clouds.openstack.identityUrl";
    @NotNull
    String USERNAME = "clouds.openstack.userName";
    @NotNull
    String PASSWORD = "clouds.openstack.password";
    @NotNull
    String TENANT = "clouds.openstack.tenant";
